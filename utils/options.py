...
[ "dqn",      "atari",  "asterix",         "shared",    "dqn-cnn" ], # 0
# [ "en_dqn",      "atari",  "asterix",         "shared",    "dqn-cnn" ], # 0
# add custom configs ...
]
...
class Params(object):
    def __init__(self):
        # training signature
        self.machine    = "APEX-pong-dqn"        # "machine_id"
