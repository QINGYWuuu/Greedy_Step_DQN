...
[ "alter_dqn",      "atari",  "asterix",         "shared",    "dqn-cnn" ], # 0
# add custom configs ...
]
...
class Params(object):
    def __init__(self):
        # training signature
        self.machine    = "APEX-pong-alter_dqn"        # "machine_id"
